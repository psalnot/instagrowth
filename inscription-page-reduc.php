			...
			<section class="main-container">
			  ...
			  <div class="container">
				...
				<a href="shop-checkout-payment.html" class="btn btn-group btn-default">Next Step <i class="icon-right-open-big"></i></a>
				  ...
				  <br><br><span class="p">Service factur&eacute;</span> <b> <?php echo $tarif_info_ttc[$mabo-1]; ?> &euro; TTC</b>   &agrave; l'issue de la p&eacute;riode de test pour toute souscription avant le 15 mai.
