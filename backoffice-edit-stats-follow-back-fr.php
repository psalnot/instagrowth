...
$evolution = $getfirstandlastsession['last']['total_followed'] - $getfirstandlastsession['first']['total_followed'];
    ...
    <div class="main-container">
			...
			<center><h3 class="text--logo light color--black">Synthèse des stats @<?php echo $user_info[11];?> </h3></center> 
			  ...
			  <div class="container">
				...
				<center><h3> Analyse des follow back par compte instagram et hashtags</h3></center>
				</br>
...
?>
			...
			<?php echo $buildmenu->buildmenuinstagrowthstats($BACKOFFICE_EDIT_INSTAGRAM,$BACKOFFICE_LOGOUT,$BACKOFFICE_EDIT_ABO,$BACKOFFICE_EDIT_COMPTE,$MAIL_SUPPORT,$MAIL_SUBJECT,$BACKOFFICE_FRONT); ?>
