...
<body data-smooth-scroll-offset="100">
  ...
  <div class="content--wrap">
			...
			<section class="main-container">
			  ...
			  <div class="container">
				...
				<div class="main2">
				 ...
				 <form action="/bxoffice-traitement/charge-dev2-2019.php" method="post" id="payment-form">
				  <div class="form-row">
				...
				<a href="shop-checkout-payment.html" class="btn btn-group btn-default">Next Step <i class="icon-right-open-big"></i></a>
                        ...
                        <div class="col-sm-5 col-sm-offset-1 col-xs-12 mt--xs--2">
                          <div class="pricing pricing-2 boxed boxed--border boxed--lg row no-gutters">
                            <div class="col-lg-12">
                              <h2>Reprise inscription </h2> <span class="p">Nous accompagnons plus de  50.000 Influenceurs<img class="rating-xs" src="img/4-5-star.png"></span>
                              <hr>
			    </div>
    ...
    <script src="js/upleap.min.js"></script>
      ...
      <script src="js/test2-dev2.js" data-rel-js></script>
