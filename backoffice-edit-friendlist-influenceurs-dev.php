...
<head>
    <meta charset="utf-8">
    <title>Edition des influenceurs </title>
...
<body data-smooth-scroll-offset="100">
  ...
  <div class="content--wrap">
    ...
    <div class="main-container">
			...
			<center><h3 class="text--logo light color--black">Influenceurs de référence</h3></center>  
			  <div class="container">
				...
				<div class="main2">
				  ...
				  <form role="form" class="form-horizontal" method="post" id="cprofilconf" action="/bxoffice-traitement/update-list-influenceurs-dev.php">
					...
					<div class="col-lg-14 col-lg-offset-1">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputInstagram1" id="inputInstagram1" value="<?php echo $friendlist[0]; ?>" placeholder="<?php echo $friendlist[0]; ?>" >
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputInstagram2" id="inputInstagram2" value="<?php echo $friendlist[1]; ?>" placeholder="<?php echo $friendlist[1]; ?>" >
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputInstagram3" id="inputInstagram3" value="<?php echo $friendlist[2]; ?>" placeholder="<?php echo $friendlist[2]; ?>" >
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputInstagram4" id="inputInstagram4" value="<?php echo $friendlist[3]; ?>" placeholder="<?php echo $friendlist[3]; ?>" >
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputInstagram5" id="inputInstagram5" value="<?php echo $friendlist[4]; ?>" placeholder="<?php echo $friendlist[4]; ?>" >
					    </div>
					  </div>
