		...
		$i++;}
		   ...
		   ?>
                    <div class="row">
                                    ...
                                    Test gratuit !
                                        ...
                                        <div class="col-sm-4">
                                            <div class="pricing pricing-1 boxed boxed--lg boxed--border"> <span class="label bg--primary-light">Populaire</span>
                                                ...
                                                <div class="price"><span class="h2">103,2 &euro; TTC<sup class="p">/Mois</sup></span> </div>
						...
						<div class="price"><span class="h2">150 &euro; TTC<sup class="p">/Mois</sup></span> </div>
						...
						<a class="btn btn--lg btn--primary type--uppercase" href="<?php echo $SIGNUP_URL . "?mvalue=4"; ?>"> <span class="btn__text">
