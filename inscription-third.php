			...
			<section class="main-container">
			  ...
			  <div class="container">
				...
				<div class="main2">
				  ...
				  <form role="form" class="form-horizontal" method="post" id="cprofilconf" action="/bxoffice-traitement/signup-etape-trois.php">
			  ...
			  <p> Aucun prélèvement avant la fin de la période d'essai.</p>
