...
<head>
    <meta charset="utf-8">
    <title>Your Instagram password </title>
...
<body data-smooth-scroll-offset="100">
  ...
  <div class="content--wrap">
    ...
    <div class="main-container">
			...
			<center><h3 class="text--logo light color--black">Your Instagram password</h3></center>  
			  <div class="container">
				...
				<div class="main2">
				  ...
				  <form role="form" class="form-horizontal" method="post" id="cprofilconf" action="<?php echo "/" . $BACKOFFICE_UPDATE_INSTAGRAM_EN; ?>">
					...
					<div class="col-lg-14 col-lg-offset-1">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputInstagram" id="inputInstagram" value="<?php echo "@" . $user_info[11]; ?>" placeholder="<?php echo "@" . $user_info[11]; ?>" disabled>
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="password" class="form-control" name="inputPassword" id="inputPassword" value="" placeholder="Password of your Instagram account" required>
					    </div>
					  </div>
			...
			<!--<?php echo $buildmenu->buildmenuinstagrowthen($BACKOFFICE_EDIT_INSTAGRAM_EN,$BACKOFFICE_LOGOUT,$BACKOFFICE_EDIT_ABO,$BACKOFFICE_EDIT_COMPTE,$MAIL_SUPPORT,$MAIL_SUBJECT,$BACKOFFICE_FRONT); ?>-->
