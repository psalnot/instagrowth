...
<head>
    <meta charset="utf-8">
    <title>Gagnez des followers : Community management ciblé</title>
			...
			<section class="main-container">
			  ...
			  <div class="container">
				...
				<div class="main2">
				  ...
				  <form role="form" class="form-horizontal" method="post" id="cprofilconf" action="/bxoffice-traitement/signup-marque-test-produit-dev2-2019.php">
				...
				<a href="shop-checkout-payment.html" class="btn btn-group btn-default">Next Step <i class="icon-right-open-big"></i></a>
				  ...
				  <!--<br><span class="p"><b>Vous ne serez pas factur&eacute; si vous annulez l'abonnement avant la fin de la p&eacute;riode de test.</b></span>-->
                                ...
                                <div class="col-lg-12">
                                  <ul class="benefits">
				    <li> <span class="checkmark bg--green"></span> <span>Avec Instagrowth vous disposez d'<b>un community manager dédié</b> pour gérer votre compte.</span> </li>
				    <li> <span class="checkmark bg--green"></span> <span>Votre community manager InstaGrowth va gérer votre compte afin  <b>d'acc&eacute;l&eacute;rer la croissance organique</b> de votre compte Instagram.</span> </li>
				    <li> <span class="checkmark bg--green"></span> <span>Votre community manager  InstaGrowth interagit avec les comptes susceptibles d'apprécier votre contenu et donc de vous suivre en retour.</li>
				    <li> <span class="checkmark bg--green"></span> <span> Votre community manager InstaGrowth vous permet de gagner de <b>200 &agrave; plus de 1000 followers par mois*</b>.</span></li>
                                    <!--<li> <span class="checkmark bg--green"></span> <span>Votre community manager Instagrowth consulte les  <b>"stories"</b> les plus populaires pour vous.</span>.</li>-->
				    
                                    <!--<li> <span class="checkmark bg--green"></span> <span>Instagrowth <b>automatise</b> les taches r&eacute;p&eacute;titives de <b>community management</b></span>.</li>-->
				    
                                  </ul>
				  <a class="btn btn--primary btn--lg" href="<?php echo $CALENDLY_RDV; ?>"> <span class="btn__text">Contactez Nous</span> </a>
				<!-- Blue car required comment-->
                                  <p class="small type--fineprint" style="margin-top: 10px;">Testez-nous gratuitement pendant <?php echo $NB_JOURS_TEST;?>  jours  <br>
				    *Gain moyen de followers constat&eacute;</p>
                                </div>
                                <!--end of pricing-->
                            </div>
                        </div>
