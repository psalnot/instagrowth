  ...
  <div class="content--wrap">
    ...
    <div class="main-container">
			...
			<section class="main-container">
			  <center><h3 class="text--logo light color--black">Mot de passe oublié
			      <br><small>Réinitialisez votre mot de passe</small></h3></center>
			  <div class="container">
				...
				<div class="main2">
				  ...
				  <form role="form" class="form-horizontal" method="post" id="cprofilconf" action="<?php echo "/" .  $BACKOFFICE_RESET_PASSWORD; ?>">
					...
					<div class="form-group">
					    <div class="text-right">
					      <button type="submit" value="submit" border="none" class="btn bg--primary-light">Réinitialiser</button> 
