		   ...
		   ?>
                    <div class="row">
                        <div class="tabs-container">
                                    ...
                                    <div class="tab__content mt--1">
                                        <div class="col-sm-4">
                                            <div class="pricing pricing-1 boxed boxed--lg boxed--border">
                                                ...
                                                <div class="pricing-description"><span class="p">Solution idéale pour les influenceurs en devenir ou TPE cherchant à acc&eacute;l&eacute;rer la croissance de leur compte et acqu&eacute;rir des followers bien <b>r&eacute;els</b>.</span></div>
                                                <hr>
                                                <ul class="perks">
						  ...
						  <li class="b">Coaching Instagram</li>
                                    ...
                                    Test gratuit !
                                        ...
                                        <div class="col-sm-4">
                                            <div class="pricing pricing-1 boxed boxed--lg boxed--border"> <span class="label bg--primary-light">Populaire</span>
                                                ...
                                                <div class="pricing-description"><span class="p">Un <b>vrai pas en avant</b> par rapport &agrave; la formule lite. L'automate identifie les hahtags les plus performants pour vous et les renouvelles chaque mois.</div>
                                                <hr>
                                                <ul class="perks">
						...
						<div class="price"><span class="h2">99 &euro; TTC<sup class="p">/Mois</sup></span> </div>
						  ...
						  <li class="a">Coaching Instagram</li>
                                                  <li class="a">Community manager dédié</li>
						  <li class="a">Identification des hashtags les plus performants</li>
                                                    <li class="a">Hashtags ciblés</li>
						    <li class="a">Commentaires personnalisables</li>
                                                    <li class="a">Cible des utilisateurs similaires</li>
                                                    <li class="a">Croissance organique du compte</li>
                                                    <li class="a">Ciblage de zones géographiques</li>
...
<p>La plupart des clients de la solution Instagrowth voient leur nombre de followers augmenter dès la première semaine, voir premiers jours pour certains.</p>
