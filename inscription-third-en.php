...
<head>
    <meta charset="utf-8">
    <title>Start your InstaGrowth free trial :  Target hashtags</title>
  ...
  <div class="content--wrap">
    ...
    <div class="main-container">
			...
			<section class="main-container">
			  <center><h3 class="text--logo light color--black">Target hashtags</h3></center>
			  ...
			  <div class="container">
				...
				<div class="main2">
				  ...
				  <form role="form" class="form-horizontal" method="post" id="cprofilconf" action="/bxoffice-traitement/signup-etape-trois-en.php">
					...
					<div class="col-lg-14 col-lg-offset-1">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputHashtag1" id="inputHashtag1" value="" placeholder="Example 'fitness' for #fitness (sans le #)" >
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputHashtag2" id="inputHashtag2" value="" placeholder="Example 'paris' for #paris (sans le #)" >
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputHashtag4" id="inputHashtag4" value="" placeholder="Example 'brunch' for #brunch (sans le #)" >
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputHashtag5" id="inputHashtag5" value="" placeholder="Example 'brunchparis' for #brunchparis (sans le #)" >
					    </div>
					  </div>
				...
				<a href="shop-checkout-payment.html" class="btn btn-group btn-default">Next Step <i class="icon-right-open-big"></i></a>
                        ...
                        <div class="col-sm-5 col-sm-offset-1 col-xs-12 mt--xs--2">
                            <div class="pricing pricing-2 boxed boxed--border boxed--lg row no-gutters">
                                <div class="col-lg-12">
                                    <h2>Step 2 of 4 </h2> <span class="p"><?php echo $MOTTO_EN_INSCRIPTION . " "; ?><img class="rating-xs" src="img/4-5-star.png"></span>
                                    <hr> </div>
                                <div class="col-lg-12">
				  <!-- Debut -->
			  ...
			  <p> You will not be billed until after your free trial ends.</p>
                      ...
                      <li class="process_item">
                        ...
                        <div class="process__body">
                          <h3>Target Hashtags </h3>
                          <p> Let us know what type of followers you'd like. Hashtags help us understand the kind of audience you are looking for</p>
                        </div>
                      </li>
                      ...
                      <li class="process_item">
                        ...
                        <div class="process__body">
                          <h3>Target similar users</h3>
                          <p> Let us know what type of followers you'd like. Similar users help us understand the kind of audience you are looking for</p>
                        </div>
                      </li>
                      ...
                      <li class="process_item">
                        ...
                        <div class="process__body">
                          <h3>Instagram password</h3>
			 
			  <p>Instagrowth bot connect to your Instagram account in order to create interactions with your audience. Your dedicated community manager supervise the bot configuration and help you identify the best hashtags and users.</p>
