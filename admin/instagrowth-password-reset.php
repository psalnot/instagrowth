...
$mrow = $muser->geturlmail($cstring,$cleaninput->genclean($_GET["memail"]));


if (!$mrow)
{
		header("location: /" . $BACKOFFICE_AUTHENTIFICATION);die();
}
$pemail = $mrow[0];
...
{
$_SESSION['bgp'] = $pemail;
$_SESSION['bgpid'] = $mrow[2]
;
$_SESSION['bgpurl'] = $cleaninput->genclean($_GET["memail"]);
}
...
<head>
    <meta charset="utf-8">
    <title>Changement de mot de passe  InstaGrowth</title>
  ...
  <div class="content--wrap">
    ...
    <div class="main-container">
			...
			<section class="main-container">
			  <center><h3 class="text--logo light color--black">Modification de votre mot de passe
			      <br><small>Saisissez votre nouveau mot de passe</small></h3></center>
			  <div class="container">
				...
				<div class="main2">
				  ...
				  <form role="form" class="form-horizontal" method="post" id="cprofilconf" action="<?php echo "/" .  $BACKOFFICE_B_AUTHENTIFICATION_RESET; ?>">
					...
					<div class="col-lg-14 col-lg-offset-1">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="email" class="form-control" name="inputEmail" id="inputEmail" value="<?php echo $pemail; ?>" placeholder="<?php echo $pemail?>" disabled>
					    </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="password" class="form-control" name="inputPassword" id="inputPassword" value="" placeholder="Votre nouveau mot de passe" required>
					    </div>
					...
					<div class="form-group">
					    <div class="text-right">
					      <button type="submit" value="submit" border="none" class="btn bg--primary-light">Modifier</button> 
                        ...
                        <div class="col-sm-5 col-sm-offset-1 col-xs-12 mt--xs--2">
                            <div class="pricing pricing-2 boxed boxed--border boxed--lg row no-gutters">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <p class="small type--fineprint" style="margin-top: 10px;">100% sans risque - Testez notre solution gratuitement pendant 5 jours</p>
                                </div>
                                <!--end of pricing-->
                            </div>
                        </div>
