<?php
	...
	include_once("../utils/defines.class.php");

	if (!isset($_GET["msign"]))
	{
		header("location: $BACKOFFICE_LOGIN");die();
	}
	...
	$pemail = $muser->geturlmail($cstring,$cleaninput->genclean($_GET["msign"]));
	...
	$muser->updateurlmail($cstring,$cleaninput->genclean($_GET["msign"]),$cremoteip,$cremotehost,$cremoteuseragent);
	header("location: $BACKOFFICE_LOGIN?mvalid=44");die();
?>
