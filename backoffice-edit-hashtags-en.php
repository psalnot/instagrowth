...
<head>
    <meta charset="utf-8">
    <title>Hashtag managements </title>
...
<body data-smooth-scroll-offset="100">
  ...
  <div class="content--wrap">
    ...
    <div class="main-container">
			...
			<center><h3 class="text--logo light color--black">Hashtags </h3></center>  
			  <div class="container">
				...
				<div class="main2">
				  ...
				  <form role="form" class="form-horizontal" method="post" id="cprofilconf" action="/bxoffice-traitement/update-list-hashtags-en.php">
