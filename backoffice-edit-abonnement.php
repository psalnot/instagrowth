    ...
    <div class="main-container">
			...
			<section class="main-container">
			  ...
			  <?php
			     ...
			     echo "<span class=\"text-black\">Test gratuit du produit jusqu'au : " .  date('d/m/Y',$test_period_end) .  " </span> </div>";
                             echo "</div>";
                             echo "</div>";
			 ...
			 <p></p>
			  <div class="row">
				  ...
				  <form>
					...
					<label for="inputEmail4">Mtt Abonnement HT</label>
					<input type="email" class="form-control" id="inputEmail4" placeholder="<?php echo $montant_ht ?>" disabled>
				      </div>
				      <div class="form-group col-md-6">
					<label for="inputPassword4">Mtt Abonnement TTC</label>
				    ...
				    <div class="form-group">
				      <center><a class="btn btn-info" href="<?php echo "/" . $BACKOFFICE_UPDATE_ABO;  ?>">
					  <span class="btn__text">
					    <?php
					       if ($user_abo[8]) { echo "Annuler abonnement"; }
					       else { echo "Activer abonnement";}
					       
					       ?>
					       </span> </a></center>
					       <?php
					       if ($info_test){
					       echo "<center><small> L'annulation de l'abonnement met fin à la période de test gratuit</small></center>";
					       }
					       ?>
