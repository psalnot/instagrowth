...
<head>
    <meta charset="utf-8">
    <title>Changer le mot de passe de votre compte InstaGrowth</title>
...
<body data-smooth-scroll-offset="100">
  ...
  <div class="content--wrap">
    ...
    <div class="main-container">
			...
			<center><h3 class="text--logo light color--black">InstaGrowth password</h3></center>  
			  <div class="container">
				...
				<div class="main2">
				  ...
				  <form role="form" class="form-horizontal" method="post" id="cprofilconf" action="<?php echo "/" .  $BACKOFFICE_UPDATE_COMPTE_EN; ?>">
					...
					<div class="col-lg-14 col-lg-offset-1">
					  ...
					  <div class="form-group">
					    <label for="shippingFirstName" class="col-md-2 control-label"><b>Login</b><small class="text-default">*</small></label>
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputEmail" id="inputEmail" value="<?php echo $user_info[0]; ?>" placeholder="<?php echo $user_info[0]; ?>" disabled>
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="password" class="form-control" name="inputPassword" id="inputPassword" value="" placeholder="Choose your new password" required>
					    </div>
					  </div>
					...
					<div class="form-group">
					    <div class="text-right">
					      <button type="submit" value="submit" border="none" class="btn bg--primary-light">Update</button> 
					...
					<!--<div class="form-group">
					    <div class="text-right">
					      <button type="submit" value="submit" border="none" class="btn bg--primary-light">Mise à jour</button> 
			...
			<!--<?php echo $buildmenu->buildmenuinstagrowthen($BACKOFFICE_EDIT_INSTAGRAM_EN,$BACKOFFICE_LOGOUT_EN,$BACKOFFICE_EDIT_ABO_EN,$BACKOFFICE_EDIT_COMPTE_EN,$MAIL_SUPPORT,$MAIL_SUBJECT,$BACKOFFICE_FRONT_EN); ?>-->
