                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 col-xs-12 text-center">
                            ...
                            <p class="lead">Choisissez votre formule !<br>
                        ...
                        <div class="col-sm-5 col-sm-offset-1 col-xs-12 mt--xs--2">
                            <div class="pricing pricing-2 boxed boxed--border boxed--lg row no-gutters">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <p class="small type--fineprint" style="margin-top: 10px;">100% sans risque - Testez notre solution pendant 5 jours</p>
                                </div>
                                <!--end of pricing-->
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                            <div class="cta">
                                <h1>Testez Instagrowth gratuitement pendant 5 jours</h1>
                                <p class="lead"> Testez notre solution gratuitement pendant 5 jours. Vous allez aimer travailler avec Instagrowth !</p>
                                ...
                                <p class="type--fineprint mt--1">Testez notre solution pendant 5 jours.</p>
                            </div>
                        </div>
                    </div>
