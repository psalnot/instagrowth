...
<html lang="fr">
  ...
  <link rel="stylesheet" type="text/css" href="css/test2.css" data-rel-css="" />
			  ...
			  <div class="container">
				...
				<div class="main2">
				 ...
				 <form id="payment-form">
				  ...
				  <button type="submit" value="submit" border="none" class="btn bg--primary-light">
				    <div class="spinner hidden" id="spinner"></div>
				    <span id="button-text">Soumettre</span>
