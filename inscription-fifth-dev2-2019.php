...
<head>
    <meta charset="utf-8">
    <title>Page d'inscription au service InstaGrowth : Quatrième étape</title>
...
<body data-smooth-scroll-offset="100">
  ...
  <div class="content--wrap">
    ...
    <div class="main-container">
			...
			<center><h3 class="text--logo light color--black">Mot de passe Instagram</h3></center>  
			  <div class="container">
				...
				<div class="main2">
				  ...
				  <form role="form" class="form-horizontal" method="post" id="cprofilconf" action="/bxoffice-traitement/signup-etape-fifth-dev2-2019.php">
					...
					<div class="col-lg-14 col-lg-offset-1">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputInstagram" id="inputInstagram" value="<?php echo $user_info[11]; ?>" placeholder="<?php echo $user_info[11]; ?>" required>
					    </div>
					  </div>

					   
					  <div class="form-group">
					    <label for="shippingFirstName" class="col-md-2 control-label">Password<small class="text-default">*</small></label>
					    <div class="col-md-10">
              ...
              <input type="hidden" name="priceId" id="priceId" value="<?php echo $STRIPE_PRICE_KEY; ?>">
					      <input type="password" class="form-control" name="inputPassword" id="inputPassword" value="" placeholder="Votre mot de passe Instagram" required>
					    </div>
					  </div>
				...
				<a href="shop-checkout-payment.html" class="btn btn-group btn-default">Next Step <i class="icon-right-open-big"></i></a>
                        ...
                        <div class="col-sm-5 col-sm-offset-1 col-xs-12 mt--xs--2">
                            <div class="pricing pricing-2 boxed boxed--border boxed--lg row no-gutters">
                                <div class="col-lg-12">
                                  <h2>Etape 3 sur 4</h2> <span class="p">Nous accompagnons plus de  50.000 Influenceurs<img class="rating-xs" src="img/4-5-star.png"></span>
		...
		<ol class="process-3">
			...
			<p>Listez les comptes Instagram que vous estimez associés à votre audience cible. Vous n'êtes pas obligé de remplir tous les champs</p>
			  <!--<p> Listez les comptes Instagram associés à votre univers.</p>-->
                      ...
                      <li class="process_item">
                        <div class="process__number two"> <span>3</span> </div>
                        <div class="process__body">
