...
<head>
    <meta charset="utf-8">
    <title>Gagnez des followers : Mass story viewing et community management ciblé</title>
			  ...
			  <div class="container">
				...
				<a href="shop-checkout-payment.html" class="btn btn-group btn-default">Next Step <i class="icon-right-open-big"></i></a>
				  ...
				  <!--<br><span class="p"><b>Vous ne serez pas factur&eacute; si vous annulez l'abonnement avant la fin de la p&eacute;riode de test.</b></span>-->
				    ...
				    <li> <span class="checkmark bg--green"></span> <span>Instagrowth permet <b>d'acc&eacute;l&eacute;rer la croissance organique</b> de votre compte Instagram.</span> </li>
				    <li> <span class="checkmark bg--green"></span> <span>Instagrowth permet <b>de consulter des stories</b> pour attirer l'attention de nouveaux followers (<b>Mass story viewing</b>)</span> </li>
				    <li> <span class="checkmark bg--green"></span> <span>Instagrowth permet de gagner de <b>500 &agrave; plus de 7800 followers par mois*</b>.</span></li>
				    <li> <span class="checkmark bg--green"></span> <span>Instagrowth c'est aussi un <b>community manager qui vous aide &agrave; optimiser</b> vos publications</span> </li>
                                    <li> <span class="checkmark bg--green"></span> <span>Instagrowth augmente le <b>"reach"</b> de vos publications sur Instagram</span>.</li>
