...
try {
    ...
    $mail->setFrom('bonjour@lesinfluenceurs.fr', 'First Last');
    //Set an alternative reply-to address
    $mail->addReplyTo('bonjour@lesinfluenceurs.fr', 'First Last');
    //Set who the message is to be sent to
    $mail->addAddress('psalnot@gmail.com', 'John Doe');
    ...
    $mail->AltBody = 'Message abonneemnt';
