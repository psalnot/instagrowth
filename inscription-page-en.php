...
<head>
    <meta charset="utf-8">
    <title>Strat your free trial</title>
  ...
  <div class="content--wrap">
    ...
    <div class="main-container">
			...
			<section class="main-container">
			  <center><h3 class="text--logo light color--black">Start your free trial</center></h3>
			  ...
			  <div class="container">
				...
				<div class="main2">
				  ...
				  <form role="form" class="form-horizontal" method="post" id="cprofilconf" action="/bxoffice-traitement/signup-marque-test-produit-dev-2018-en.php">
					...
					<div class="col-lg-14 col-lg-offset-1">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      ...
					      <input type="text" class="form-control" name="inputEmail" id="inputEmail" value="" placeholder="Your email address" required>
					    </div>
					  </div>
					  
					  <div class="form-group">
					    <label for="shippingFirstName" class="col-md-2 control-label">Name<small class="text-default">*</small></label>
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputName" id="inputName" value="" placeholder="Last name" required>
					    </div>
					  </div>

					  
					  <div class="form-group">
					    <label for="shippingFirstName" class="col-md-2 control-label">Company name<small class="text-default"></small></label>
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputCompany" id="inputCompany" value="" placeholder="Company name (Optional)">
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputInstagram" id="inputInstagram" value="" placeholder="Your Instagram account name" required>
					    </div>
					  </div>

					  
					  <div class="form-group">
					    <label for="shippingLastName" class="col-md-2 control-label">Phone<small class="text-default">*</small></label>
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputPhone" id="inputPhone" value="" placeholder="Your phone number" required>
					    </div>
					  </div>
					  <div class="form-group has-feedback">
					    <label for="shippingTel" class="col-md-2 control-label">Password<small class="text-default">*</small></label>
					    <div class="col-md-10">
					      <input type="password" class="form-control" name="inputPassword" id="inputPassword" value="" placeholder="Your password" required>
					...
					<div class="form-group">
					    ...
					    <center><small><b> <a href="<?php echo $CGV_CGU; ?>"> Legal terms</a> </b></small></center>
					</div>
				...
				<a href="shop-checkout-payment.html" class="btn btn-group btn-default">Next Step <i class="icon-right-open-big"></i></a>
                        ...
                        <div class="col-sm-5 col-sm-offset-1 col-xs-12 mt--xs--2">
                            <div class="pricing pricing-2 boxed boxed--border boxed--lg row no-gutters">
                                <div class="col-lg-12">
                                    <h2>Start your <?php echo $NB_JOURS_TEST;?>  days free trial</h2> <span class="p"><?php echo $MOTTO_EN_INSCRIPTION; ?><img class="rating-xs" src="img/4-5-star.png"></span>
                                    <hr> </div>
                                <div class="col-lg-12">
                                  <ul class="benefits">
                                  ...
                                  <a class="btn btn--primary btn--lg" href="<?php echo $CALENDLY_RDV; ?>"> <span class="btn__text">Contact us</span> </a>
                                    <p class="small type--fineprint" style="margin-top: 10px;"><?php echo $NB_JOURS_TEST;?>  days free trial | Credit card required </p>
                                </div>
                                <!--end of pricing-->
                            </div>
                        </div>
