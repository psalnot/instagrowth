...
<head>
    <meta charset="utf-8">
    <title>Edition des commentaires </title>
...
<body data-smooth-scroll-offset="100">
  ...
  <div class="content--wrap">
    ...
    <div class="main-container">
			...
			<center><h3 class="text--logo light color--black">Commentaires personnalisés</h3></center>  
			  <div class="container">
				...
				<div class="main2">
				  ...
				  <form role="form" class="form-horizontal" method="post" id="cprofilconf" action="/bxoffice-traitement/update-list-commentaires.php">
					...
					<div class="col-lg-14 col-lg-offset-1">
					  ...
					  <div class="form-group">
					    <label for="shippingFirstName" class="col-md-2 control-label">Commentaire<small class="text-default"></small></label>
					    <div class="col-md-10">
					  ...
					  <div class="form-group">
					    <label for="shippingFirstName" class="col-md-2 control-label">Commentaire2<small class="text-default"></small></label>
					    <div class="col-md-10">
					  ...
					  <div class="form-group">
					    <label for="shippingFirstName" class="col-md-2 control-label">Commentaire3<small class="text-default"></small></label>
					    <div class="col-md-10">
					  ...
					  <div class="form-group">
					    <label for="shippingFirstName" class="col-md-2 control-label">Commenaire4<small class="text-default"></small></label>
					    <div class="col-md-10">
