...
class InstagramInteractApi {
     ...
     */
    public function usernameExists(string $instagram_username): bool {
        $sql = "SELECT COUNT(*) FROM instagram_interact WHERE instagram_username = :instagram_username";
    ...
    public function insertOrUpdateData(array $data, string $remoteHost) {
        if ($this->usernameExists($data['instagram_username'])) {
