    ...
    <div class="content--wrap">
        ...
        <div class="main-container">
            <section>
			    ...
			    <span class="h3"><p style="color:red">Tarifs valables pour toute souscription avant le 5 avril</p></span>
                            <!--<a class="btn btn--lg btn--primary type--uppercase" href="<?php echo $SIGNUP_URL; ?>"> <span class="btn__text btntxt-fix">
                                    Offre valable <span class="emoji">👈</span> </span>-->
                            </a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="tab__content mt--1">
                                        <div class="col-sm-4">
                                            <div class="pricing pricing-1 boxed boxed--lg boxed--border">
                                                ...
                                                <div class="price"><span class="h2"><del>86 &euro; TTC</del><sup class="p">/Mois</sup><br> 30 &euro; TTC<sup class="p">/Mois</sup></span> </div>
                                    ...
                                    Test gratuit !
                                        ...
                                        <div class="col-sm-4">
                                            <div class="pricing pricing-1 boxed boxed--lg boxed--border"> <span class="label bg--primary-light">Populaire</span>
                                                ...
                                                <div class="price"><span class="h2"><del>150 &euro; TTC </del><sup class="p">/Mois</sup><br>
								86 &euro; TTC <sup class="p">/Mois</sup>							 
								</span> </div>
