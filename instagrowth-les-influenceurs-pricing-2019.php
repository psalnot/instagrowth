		   ...
		   ?>
                    <div class="row">
                        <div class="tabs-container">
                                    ...
                                    <div class="tab__content mt--1">
                                        <div class="col-sm-4">
                                            <div class="pricing pricing-1 boxed boxed--lg boxed--border">
                                                ...
                                                <div class="price"><span class="h2">45 &euro; TTC<sup class="p">/Mois</sup></span> </div>
                                                <div class="pricing-description"><span class="p">Solution idéale pour les influenceurs en devenir ou TPE cherchant à acc&eacute;l&eacute;rer la croissance de leur compte et acqu&eacute;rir des followers bien <b>r&eacute;els</b>.<br>
						    </span>
						</div>
                                                <hr>
                                                <ul class="perks">
						  ...
						  <li class="a"><b>+750 followers</b> par mois*</li>
                                                  <li class="b">Community manager dédié</li>
						  <li class="b">Identification des hashtags les plus performants</li>
						    ...
						    <li class="a">Commentaires personnalisables</li>
                                                    ...
                                                    <li class="a">Ciblage d'<b>une zone g&eacute;ographique</b></li>                                                  
						    ...
						    <li class="b">Support téléphonique</li>
                                                ...
                                                <a class="btn btn--lg btn--primary type--uppercase" href="<?php echo $SIGNUP_URL . "?mvalue=7"; ?>"> <span class="btn__text">
                                    Test gratuit !
                                </span> </a>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="pricing pricing-1 boxed boxed--lg boxed--border"> <span class="label bg--primary-light">Populaire</span>
                                                ...
                                                <div class="price"><span class="h2">86 &euro; TTC<sup class="p">/Mois</sup></span> </div>
                                                <div class="pricing-description"><span class="p">Un <b>vrai pas en avant</b> par rapport &agrave; la formule lite. L'automate identifie les hahtags les plus performants pour vous et les renouvelles chaque mois.<br>
</span>
						</div>
                                                <hr>
                                                <ul class="perks">
						  ...
						  <li class="a">+<b>1 500 followers</b> par mois*</li>
						  ...
						  <li class="a">Identification des hashtags les plus performants</li>
						    ...
						    <li class="a">Commentaires personnalisables</li>
                                                    <li class="a">Cible des utilisateurs similaires</li>
                                                    <li class="a">Croissance organique du compte</li>
                                                    <li class="a">Ciblage de <b>deux zones géographiques</b></li>
                                                  <li class="b">Exclusion de mots clés et comptes</li>						    
						    <li class="a">Support téléphonique</li>
                                                ...
                                                <a class="btn btn--lg btn--primary type--uppercase" href="<?php echo $SIGNUP_URL . "?mvalue=3"; ?>"> <span class="btn__text">
						    Test gratuit !
                                </span> </a>
                                            </div>
                                        </div>
						...
						<div class="price"><span class="h2">99 &euro; TTC<sup class="p">/Mois</sup></span> </div>
                                                <!--<div class="price"><span class="h2">Sur devis<sup class="p"></sup></span> </div>-->
                                                <div class="pricing-description"><span class="p"> Mettez toutes les chances de r&eacute;ussites de votre coté, vous disposez d'un coach qui chaque mois en plus de l'automate vous conseille pour optimiser vos publications.
						    </span>
						  ...
						  <li class="a"><b>+1 800 followers</b> par mois*</li>
                                                  <li class="a">Community manager dédié</li>
						  <li class="a">Identification des hashtags les plus performants</li>
                                                    <li class="a">Hashtags ciblés</li>
						    <li class="a">Commentaires personnalisables</li>
                                                    <li class="a">Cible des utilisateurs similaires</li>
                                                    <li class="a">Croissance organique du compte</li>
                                                    <li class="a">Ciblage de <b>quatre zones géographiques</b></li>
						...
						<a class="btn btn--lg btn--primary type--uppercase" href="<?php echo $SIGNUP_URL . "?mvalue=8"; ?>"> <span class="btn__text">
...
<p>Notre solution permet d'automatiser les taches répétitives sur Instagram comme Follow/unfollow, répondre aux commentaires, "liker des publications". Grâce à ces actions, nous attirons massivement l'attention d'utilisateurs aimant votre thématique.
...
<h5>Est-il possible de personnaliser les commentaires de l'automate ?</h5>
