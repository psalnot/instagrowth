...
<head>
    <meta charset="utf-8">
    <title>Start your free trial : Target similar users</title>
...
<body data-smooth-scroll-offset="100">
  ...
  <div class="content--wrap">
    ...
    <div class="main-container">
			...
			<center><h3 class="text--logo light color--black">Target similar users</h3></center>  
			  <div class="container">
				...
				<div class="main2">
				  ...
				  <form role="form" class="form-horizontal" method="post" id="cprofilconf" action="/bxoffice-traitement/signup-etape-fourth-en.php">
					...
					<div class="col-lg-14 col-lg-offset-1">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputInstagram1" id="inputInstagram1" value="" placeholder="Example 'aviron' for @aviron" >
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputInstagram2" id="inputInstagram2" value="" placeholder="Example 'aviron' for @aviron" >
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputInstagram4" id="inputInstagram4" value="" placeholder="Example 'aviron' for @aviron" >
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputInstagram5" id="inputInstagram5" value="" placeholder="Example 'aviron' for @aviron" >
					    </div>
					  </div>
				...
				<a href="shop-checkout-payment.html" class="btn btn-group btn-default">Next Step <i class="icon-right-open-big"></i></a>
                        ...
                        <div class="col-sm-5 col-sm-offset-1 col-xs-12 mt--xs--2">
                            <div class="pricing pricing-2 boxed boxed--border boxed--lg row no-gutters">
                                <div class="col-lg-12">
                                  <h2>Step 3 of 4</h2> <span class="p"><?php echo $MOTTO_EN_INSCRIPTION . " "; ?><img class="rating-xs" src="img/4-5-star.png"></span>
                                    <hr> </div>
                                <div class="col-lg-12">
				  <!-- Debut -->
