            ...
            if (options.container != "") {
                ...
                //    html += "<img class='instagram_profile_image' src='" + data.profile_pic_url  + "' alt='"+ (is_tag ? data.name + " tag pic" : data.username + " profile pic") + "'" + styles.profile_image + (options.lazy_load ? " loading='lazy'" : '') + " />";
                    if (is_tag)
                        ...
                        html += " <a class='instagram_username' href='https://www.instagram.com/" + options.username + "' rel='noopener' target='_blank'>@" + options.username + " <span>Follow us</span></a>";
                ...
                if (options.display_gallery) {
                    if (typeof data.is_private !== "undefined" && data.is_private === true) {
                        ...
                        for (var i = 0; i < max; i++) {
                            ...
                            html += "<a href='" + url + "' class='instagram-item instagram-" + type_resource + "' rel='noopener' target='_blank'>";
                            html += "<img" + (options.lazy_load ? " loading='lazy'" : '')  + " src='" + image + "' alt='" + escape_string(caption) + "'" + styles.gallery_image +" />";
                           //imgs[i].node.edge_liked_by
                            html += "<span class='instagram-likes'><i class='fa fa-heart'></i> "+imgs[i].node.edge_liked_by.count+"</span>";
                            html += "</a>";
                        }
                        html += "</div>";
                    }
