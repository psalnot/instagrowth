            ...
            ajaxContentAdded: function () {
                ...
                $("#Form_RegisterForm").validate({
                    ...
                    messages: {
                        ...
                        Password: {
                            remote: "Password must be at least 8 characters long."
                        }
                    },
                ...
                var script_select2 = document.createElement('script');
                script_select2.src = "mysite/bower_components/select2/dist/js/select2.full.min.js";
                script_select2.onload = function () {
                    $("select.dropdown").select2({
                        minimumResultsForSearch: -1
                    });
                };
                document.body.appendChild(script_select2);
...
function showClientRegistrationPopup() {
    $.magnificPopup.open({
        ...
        type: 'ajax',
        items: {
	    src: '/UBOOKER/client-register-popup.htm',
	    crossOrigin: null
	},
        ajax: {
            settings: {
                data: {
                    template: "ClientRegistrationPopup"
                }
            },
            cursor: 'mfp-ajax-cur', // CSS class that will be added to body during the loading (adds "progress" cursor)
            tError: '<a href="%url%">The content</a> could not be loaded.' //  Error message, can contain %curr% and %total% tags if gallery is enabled
                    ...
                    rules: {
                        ...
                        WebpageLink: {
                            ...
                            required: function(element) {
                                var linkedin_empty = $("#Form_ValidationForm_LinkedinLink").is(':blank');
                                var instagram_empty = $("#Form_ValidationForm_InstagramLink").is(':blank');
                                return linkedin_empty && instagram_empty;
                            },
                            minlength: 1,
                            remote: {
                        ...
                        LinkedinLink: {
                            email: false,
                            required: function(element) {
                                var webpage_empty = $("#Form_ValidationForm_WebpageLink").is(':blank');
                                var instagram_empty = $("#Form_ValidationForm_InstagramLink").is(':blank');
                                return webpage_empty && instagram_empty;
                            },
                            minlength: 1,
                            remote: {
                                url: "/register/checkurl",
                        ...
                        InstagramLink: {
                            ...
                            required: function(element) {
                                var linkedin_empty = $("#Form_ValidationForm_LinkedinLink").is(':blank');
                                var webpage_empty = $("#Form_ValidationForm_WebpageLink").is(':blank');
                                return linkedin_empty && webpage_empty;
                            },
                            minlength: 1,
                            remote: {
                                url: "/register/checkurl",
