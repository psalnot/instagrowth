			...
			<center><h3 class="text--logo light color--black">Mot de passe Instagram</h3></center>  
			  <div class="container">
				...
				<div class="main2">
				  ...
				  <form role="form" class="form-horizontal" method="post" id="cprofilconf" action="/bxoffice-traitement/signup-etape-fifth.php">
				...
				<a href="shop-checkout-payment.html" class="btn btn-group btn-default">Next Step <i class="icon-right-open-big"></i></a>
                        ...
                        <div class="col-sm-5 col-sm-offset-1 col-xs-12 mt--xs--2">
                            <div class="pricing pricing-2 boxed boxed--border boxed--lg row no-gutters">
                                <div class="col-lg-12">
                                  <h2>Etape 4 sur 4</h2> <span class="p">Nous accompagnons plus de  50.000 Influenceurs<img class="rating-xs" src="img/4-5-star.png"></span>
                    ...
                    <ol class="process-3">
                      <li class="process_item">
                        ...
                        <div class="process__body">
                          ...
                          <p> Référencez vos coordonnées bancaires</p>
                        </div>
                      </li>
                      ...
                      <li class="process_item">
                        <div class="process__number three"> <span>3</span> </div>
                        <div class="process__body">
			...
			<p> Listez les comptes Instagram que vous estimez associés à votre audience cible. Vous n'êtes pas obligé de remplir tous les champs</p>
			 <!-- <p> Listez les comptes Instagram associés à votre univers</p>-->
                      ...
                      <li class="process_item">
                        ...
                        <div class="process__body">
			  <h3>Votre mot de passe Instagram</h3>
			<p>Pour gérer les opérations de community management et ainsi favoriser la croissance organique de votre compte, il est nécessaire de se connecter à votre compte Instagram.</p>	
