...
# $sql = "select user.email,user.phone, user.name, user.lastname, user.company, user.date_create, user.date_update, user.remote_ip, user.remote_user_agent, user.remote_host, user.password, user.instagram from user  where  id=" . $user_id;
       ...
       $instagram = $user_info[11];

       echo "Instagram: " . $instagram . " Name: " . $cname . " Email: "  . $cemail;
    ...
    <div class="main-container">
			...
			<!-- ================ -->
			     <!--<p class="lead">Choisissez votre formule !<br> Vous pouvez résilier votre abonnement à tout moment. </p>
                            <a class="btn btn--lg btn--primary type--uppercase" href=""> <span class="btn__text btntxt-fix">
			...
			<center><h3 class="text--logo light color--black">Planifiez votre appel de lancement</h3></center>  
			  <div class="container">
...
Cal("init", "30min", {origin:"https://cal.com"});
  				...
  				Cal.ns["30min"]("inline", {
					...
					calLink: "instagrowth/30min",
					layout: "month_view",
					prefill: {
       				        	email: "<?php echo $cemail; ?>",      // Email dynamique
       						name: "<?php echo $cname; ?>",        // Nom dynamique
        					customAnswers: {
            						"instagram": "<?php echo $instagram; ?>" // Instagram dynamique
        					}
    					}
  				});

  				Cal.ns["30min"]("ui", {"styles":{"branding":{"brandColor":"#000000"}},"hideEventTypeDetails":true,"layout":"month_view"});
  				</script>
		...
		<ol class="process-3">
			...
			<p> Pour gérer les opérations de community management et ainsi favoriser la croissance organique de votre compte, il est nécessaire de se connecter à votre compte. </p> 
		      ...
		      <li class="process_item">
                        <div class="process__number two"> <span>4</span> </div>
                        <div class="process__body">
