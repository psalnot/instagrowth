...
<head>
    ...
    <?php
       ...
       include_once("utils/instagrowth-les-influenceurs-header-meta-en.php");
?>
  ...
  <div class="content--wrap">
    ...
    <div class="main-container">
			...
			<section class="main-container">
			  <center><h3 class="text--logo light color--black">Credit card details </h3></center>
			  <center><h4 class="text--logo light color--primary">You will not be billed until after your free trial ends</h4></center>
			  ...
			  <div class="container">
				...
				<div class="main2">
				 ...
				 <form action="/bxoffice-traitement/charge-en.php" method="post" id="payment-form">
				  <div class="form-row">
				...
				<a href="shop-checkout-payment.html" class="btn btn-group btn-default">Next Step <i class="icon-right-open-big"></i></a>
                        ...
                        <div class="col-sm-5 col-sm-offset-1 col-xs-12 mt--xs--2">
                          <div class="pricing pricing-2 boxed boxed--border boxed--lg row no-gutters">
                            <div class="col-lg-12">
                              <h2>Step 1 of 4</h2> <span class="p"><?php echo $MOTTO_EN_INSCRIPTION . " "; ?><img class="rating-xs" src="img/4-5-star.png"></span>
                              <hr>
			    </div>
			  ...
			  <p>Instagrowth bot use your instagram account in order to create interactions with your audience. Your dedicated community manager supervise the bot configuration and help you identify the best hashtags and users.</p>
