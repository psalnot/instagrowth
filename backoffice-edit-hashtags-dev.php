...
<head>
    <meta charset="utf-8">
    <title>Edition des hashtags </title>
...
<body data-smooth-scroll-offset="100">
  ...
  <div class="content--wrap">
    ...
    <div class="main-container">
			...
			<center><h3 class="text--logo light color--black">Hashtags de référence</h3></center>  
			  <div class="container">
				...
				<div class="main2">
				  ...
				  <form role="form" class="form-horizontal" method="post" id="cprofilconf" action="/bxoffice-traitement/update-list-hashtags-dev.php">
					...
					<div class="col-lg-14 col-lg-offset-1">
					  ...
					  <div class="form-group">
					    <label for="shippingFirstName" class="col-md-2 control-label">Hashtag<small class="text-default">*</small></label>
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputHashtag1" id="inputHashtag1" value="<?php echo $htags[0]; ?>" placeholder="<?php echo $htags[0]; ?>" >
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputHashtag2" id="inputHashtag2" value="<?php echo $htags[1]; ?>" placeholder="<?php echo $htags[1]; ?>" >
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputHashtag3" id="inputHashtag3" value="<?php echo $htags[2]; ?>" placeholder="<?php echo $htags[2]; ?>" >
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputHashtag4" id="inputHashtag" value="<?php echo $htags[3]; ?>" placeholder="<?php echo $htags[3]; ?>" >
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="text" class="form-control" name="inputHashtag5" id="inputHashtag5" value="<?php echo $htags[4]; ?>" placeholder="<?php echo $htags[4]; ?>" >
					    </div>
					  </div>
