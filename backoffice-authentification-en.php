...
<head>
    <meta charset="utf-8">
    <title>Connect to your InstaGrowth account</title>
  ...
  <div class="content--wrap">
    ...
    <div class="main-container">
			...
			<section class="main-container">
			  <center><h3 class="text--logo light color--black">Authentication
			      <br><small> Connect to your InstaGrowth account</small></h3></center>
			  <div class="container">
				...
				<div class="main2">
				  ...
				  <form role="form" class="form-horizontal" method="post" id="cprofilconf" action="<?php echo "/" .  $DEV_BACKOFFICE_AUTHENTIFICATION_EN; ?>">
					...
					<div class="col-lg-14 col-lg-offset-1">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="email" class="form-control" name="inputEmail" id="inputEmail" value="" placeholder="Your e-mail" required>
					    </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-10">
					      <input type="password" class="form-control" name="inputPassword" id="inputPassword" value="" placeholder="Password" required>
					    </div>
					...
					<div class="form-group">
					    <div class="text-right">
					      <button type="submit" value="submit" border="none" class="btn bg--primary-light">Authentication</button> 
					      <!--<button type="submit" value="submit" >Soumettre </button>-->
					      
					    </div>
					    <center><small><b> Legal terms <a href="<?php echo $CGV_CGU; ?>">CGV/CGU</a> </b></small></center>
					    <center><small><b> <a href="<?php echo $BACKOFFICE_FRONT_RESET_PASSWORD_EN; ?>">Forgot password</a>  </b></small></center>
					</div>
