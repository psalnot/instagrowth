			  ...
			  <div class="container">
				...
				<a href="shop-checkout-payment.html" class="btn btn-group btn-default">Next Step <i class="icon-right-open-big"></i></a>
				  ...
				  <!--<br><span class="p"><b>Vous ne serez pas factur&eacute; si vous annulez l'abonnement avant la fin de la p&eacute;riode de test.</b></span>-->
				    ...
				    <li> <span class="checkmark bg--green"></span> <span> Votre community manager InstaGrowth vous permet de gagner de <b>500 &agrave; plus de 7800 followers par mois*</b>.</span></li>
                                  ...
                                  <p class="small type--fineprint" style="margin-top: 10px;">Testez-nous gratuitement pendant <?php echo $NB_JOURS_TEST;?>  jours | Carte bleue requise <br>
